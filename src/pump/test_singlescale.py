...
def arg_parser():
    ...
    parser.add_argument('--forward', choices='torch cuda cuda-lowmem mps cpu'.split(), default='cuda-lowmem')
    parser.add_argument('--backward', choices='python torch cuda mps cpu'.split(), default='cuda')
    parser.add_argument('--reciprocal', choices='cpu cuda mps cpu'.split(), default='cpu')
...
class Main:
    ...
    def get_options( args ):
        ...
        pixel_desc = PixelDesc(path=f'pump/checkpoints/{args.desc}.pt')
